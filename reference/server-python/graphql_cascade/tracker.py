...
class CascadeTransaction:
    ...
    def __enter__(self):
        self.tracker.start_transaction()
        return self
...
class CascadeTracker:
    ...
    def _ensure_transaction(self) -> None:
        ...
        if not self.in_transaction:
            raise RuntimeError("No cascade transaction in progress. Use CascadeTransaction context manager.")
    ...
    def _serialize_value(self, value: Any) -> Any:
        ...
        if value is None:
            ...
            return {
                '__typename': self._get_entity_type(value),
                'id': self._get_entity_id(value)
            }
        else:
