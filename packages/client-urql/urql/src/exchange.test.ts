...
describe("cascadeExchange", () => {
  ...
  it("should process cascade data correctly", () => {
    ...
    expect(mockCacheAdapter.write).toHaveBeenCalledWith("User", "1", {
      name: "Updated",
    });
  });
  ...
  it("should handle multiple operations through exchange", () => {
    ...
    expect(mockCacheAdapter.write).toHaveBeenCalledWith("User", "2", {
      name: "Updated2",
    });
  });
