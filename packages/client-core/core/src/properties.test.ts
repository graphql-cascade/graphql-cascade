...
const queryInvalidationArb: fc.Arbitrary<QueryInvalidation> = fc.record({
  ...
  strategy: fc.constantFrom(
    ...
    InvalidationStrategy.REFETCH,
    InvalidationStrategy.REMOVE,
  ),
...
function deduplicateDeletedEntities(
            ...
            const response: CascadeResponse = {
              ...
              cascade: {
                ...
                metadata: {
                  ...
                  depth: 1,
                  affectedCount: entities.length * 2,
                },
              },
            };
            ...
            const writeResponse: CascadeResponse = {
              ...
              cascade: {
                ...
                metadata: {
                  timestamp: new Date().toISOString(),
                  depth: 1,
                  affectedCount: entitiesToDelete.length,
                },
              },
            };
            ...
            const deleteResponse: CascadeResponse = {
              ...
              cascade: {
                ...
                metadata: {
                  timestamp: new Date().toISOString(),
                  depth: 1,
                  affectedCount: deletions.length * 2,
                },
              },
            };
      ...
      fc.assert(
        fc.property(
          ...
          (invalidations, metadata) => {
            ...
            return (
              cache.getStateSnapshot().size === 0 &&
              cache.operations.length === invalidations.length
            );
          },
        ),
        ...
        fc.property(
          ...
          (updates, deletions, invalidations, metadata) => {
            ...
            const expectedOperations =
              updates.length + deletions.length + invalidations.length;
