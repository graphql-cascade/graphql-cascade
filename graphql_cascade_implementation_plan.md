...
│       └── E_examples.md
│
├── server-reference/        # Python/FraiseQL reference implementation
│   ├── graphql_cascade/
│   │   ├── __init__.py
...
- `server-reference/graphql_cascade/tracker.py`
- `server-reference/graphql_cascade/builder.py`
- `server-reference/graphql_cascade/invalidator.py`
- `server-reference/graphql_cascade/middleware.py`
- `server-reference/graphql_cascade/config.py`
...
- `client-reference/packages/core/` (core library)
- `client-reference/packages/apollo/` (@graphql-cascade/apollo)
- `client-reference/packages/relay/` (@graphql-cascade/relay)
- `client-reference/packages/react-query/` (@graphql-cascade/react-query)
- `client-reference/packages/urql/` (@graphql-cascade/urql)
